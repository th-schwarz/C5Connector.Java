...
/**
 * Holds the url-paths of the icons of the filemanager. It's used by the implementation of the {@link IconResolver} 
 * to hold the icon data for each different url-path.
 */
public final class IconRequestResolver {
	...
	public String getIconPathForDirectory() {
		return iconsPerExt.get(IconResolver.key_directory);
	}
}
